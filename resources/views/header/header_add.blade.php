...
<body>
    ...
    <form action="{{url('header/add')}}" method="POST" id="demo1" class="demo" style="display:none;" autocomplete="off" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="container">
      <br>
      <ol class="breadcrumb">
    	...
    	<div class="card" >
    		...
    		<div class="row">
              ...
              <p>
                   <label>อำเภอ</label>
                   <input class="form-control" name="amphoe" type="text"  value="{{Auth::user()->amphoe}}" disabled>
               </p>
               <p>
                    <label>สถานะ</label>
            ...
            <p>
              <label>ตำบล</label>
              <input class="form-control" name="district" type="text" value="{{Auth::user()->district}}" disabled>
            </p>
            <p>
              <label>จังหวัด</label>
              <input class="form-control" name="province" type="text" value="{{Auth::user()->province}}" disabled>
            </p>
